      ...
      <div className="flex justify-center flex-col">
                        ...
                        <form className="flex flex-col lg:flex-row lg:gap-3">
                          ...
                          <div className="grid grid-cols-4 gap-3">
                            <label className="col-span-2 block text-sm leading-6 text-gray-800"> Nombre <br />
                              <input className="px-2 border border-20 shadow w-full" type="text" name="gName" defaultValue={z?.gName}
                              onChange={(e) => {setGName(e.target.value); }}/>
                            </label>
                            <label className="col-span-2 block text-sm leading-6 text-gray-800"> Apellido <br />
                              <input className="px-2 border border-20 shadow w-full" type="text" name="gLastName" defaultValue={z?.gLastName}
                            ...
                            <label className="col-span-4 lg:col-span-2  block text-sm leading-6 text-gray-800"> Teléfono <br />
                              <input className="px-2 border border-20 shadow w-full" type="number" name="gTel" defaultValue={z?.gTel}
                            ...
                            <label className="col-span-2 lg:col-span-1 block text-sm leading-6 text-gray-800"> Identificación <br />
                              <input className="px-2 border border-20 shadow w-full" type="text" name="gTypeDoc"  defaultValue={z?.gTypeDoc}
                              onChange={(e) => {setGTypeDoc(e.target.value); }}/>
                            </label>
                            <label className="col-span-2 lg:col-span-1 block text-sm leading-6 text-gray-800"> <br />
                              <input className="px-2 border border-20 shadow w-full" type="text" name="gNumDoc"  defaultValue={z?.gNumDoc}
                          ...
                          <div className="w-full lg:w-1/2">
                            <label className="block text-sm leading-6 text-gray-800"> Comentarios <br />
                              ...
                              defaultValue={z?.gExtraInfo}
                              onChange={(e) => {setGExtraInfo(e.target.value); }}/>
                            </label>
                          </div>
                        </form>

                            <span onClick={() => { handleResGuests(index) }} className="font-bold text-accent mt-2 pt-2 hover:text-accent-hover cursor-pointer border-t-2 flex justify-end ">Guardar</span> 
        ...
        <div className="flex flex-col lg:flex-row lg:gap-5">
            <div className="mb-5 flex flex-col  w-full">
              <label htmlFor="mail">Por favor, Facilite un Email para recibir la confirmación de la Reserva</label>
              <input id="email" type="email" className="w-full shadow-xl border-2 p-2" defaultValue={email} 
